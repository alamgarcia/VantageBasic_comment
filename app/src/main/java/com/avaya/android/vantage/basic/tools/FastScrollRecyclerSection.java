package com.avaya.android.vantage.basic.tools;
...
public class FastScrollRecyclerSection extends RecyclerView.AdapterDataObserver {
    ...
    private float setIndexbarWidth = FastScrollRecyclerView.mIndexbarWidth;
    private float setIndexbarMargin = FastScrollRecyclerView.mIndexbarMargin;
    ...
    private float fontSize = FastScrollRecyclerView.mFontSize;
